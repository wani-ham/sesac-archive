    ...
    return (
        <div className="Box4">
            ...
            <div>
              ...
              <button onClick={(e) => dispatch(plus({payload: {money: e.target.parentElement.firstChild.value}}))}>입금</button>
              <button onClick={(e) => dispatch(minus({payload: {money: e.target.parentElement.firstChild.value}}))}>출금</button>
            </div>
